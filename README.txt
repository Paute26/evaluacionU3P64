...
a persistence unit "evaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "eva/pom.xml":
...
artifact ("eva.war") is already built. You can build
